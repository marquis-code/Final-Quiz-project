  ...
  submit = (event) => {
    ...
    if (
      ...
      axios({
        ...
        .then(() => {
          M.toast({ 
            html: "New question was successfully created",
            classes: "tost-valid",
            displayLength: 1500,
          })
        ...
        <form onSubmit={this.submit}>
          ...
          <div className="form-group">
            ...
            {this.state.errors.optionA && (
              <div className="text-danger">{this.state.errors.optionA}</div>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {this.state.errors.optionB && (
              <div className="text-danger">{this.state.errors.optionB}</div>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {this.state.errors.optionC && (
              <div className="text-danger">{this.state.errors.optionC}</div>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {this.state.errors.optionD && (
              <div className="text-danger">{this.state.errors.optionD}</div>
            )}
          </div>
